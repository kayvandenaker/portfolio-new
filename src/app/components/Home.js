  ...
  return (
    ...
    <div className='container'>
      ...
      <div className='intro'>
        <div>
          ...
          <div className='contact-container'>
            <span className='contact-title' onClick={() => setContact(contact ? false : true)}>{contact? "↘":"→"} <span>Contact</span><br/></span> 
            <span className={'contact ' + (contact ? "active" : "")}>
            {/* <span className={'contact active'}> */}
              <a className='link' href="mailto:kayvandenaker@gmail.com" target="_blank" onClick={() => setContact(false)}>Email</a>
              <span className='spacer'>/</span>
              <a className="link" href="https://www.instagram.com/aker.industries/" target="_blank" onClick={() => setContact(false)}>Instagram</a>
              <span className='spacer'>/</span>
              <a className="link" href="https://www.linkedin.com/in/kayvandenaker" target="_blank" onClick={() => setContact(false)}>LinkedIn</a>
              <span className='spacer'>/</span>
              <a className="link" href="https://twitter.com/kayvandenaker" target="_blank" onClick={() => setContact(false)}>Twitter</a>
              <span className='spacer'>/</span>
              <a className="link" href='./files/Kay_van_den_Aker.pdf' target="_blank" onClick={() => setContact(false)}>Resume</a>
            </span>
          </div>
          </p>
        </div>
      ...
      <ResponsiveMasonry columnsCountBreakPoints={{350: 1, 760: 2, 1140: 3, 1360: 4}}>
        ...
        {/* <Masonry gutter={"20px"} ref={masonryRef} className={"masonry "}> */}
        {/* <div className='grid'>
            <div> */}
