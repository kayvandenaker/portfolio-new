    ...
    <div className="container">
      <div className="intro">
        <p>
          ...
          Currently contracting at <span className="desktopText">the </span><a href='https://ai.google/' target="_blank">Google<span className="desktopText"> Envisioning Studio</span></a>. Previous public work is listed bellow, projects for <a href='https://modemworks.com/' target="_blank">Modem Works</a>, <a href='https://x.company/' target="_blank">Google X</a>, <a href='https://www.rolls-roycemotorcars.com/' target="_blank">Rolls-Royce</a> and others remain confidential. 
          <br /><br />
