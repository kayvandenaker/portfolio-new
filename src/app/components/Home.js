    ...
    <div className="container">
      <div className="intro">
        <p>
          ...
          <br />
          <br />
          Designer and prototyper, exploring interactions that fuse digital and physical. Turning ambiguous ideas into experiences by gluing together various hard<span className="mobileText"> &</span>
          ...
          . Previous public work is listed below, projects for{" "}
          <a href="https://modemworks.com/" target="_blank">
            Modem Works
          </a>
          ,{" "}
          <a href="https://x.company/" target="_blank">
            Google X
          </a>
          ,{" "}
          ...
          <span className="contact-container">
            <a className="link" href="mailto:kayvandenaker@gmail.com" target="_blank">
              Email
            </a>
            <a className="link" href="https://www.linkedin.com/in/kayvandenaker" target="_blank">
              LinkedIn
            </a>
            <a className="link" href="https://www.instagram.com/aker.industries/" target="_blank">
              Instagram
            </a>
            <a className="link" href="https://twitter.com/kayvandenaker" target="_blank">
              X
            </a>
            <a className="link" href="./files/Kay_van_den_Aker.pdf" target="_blank">
              Resume
            </a>
          </span>
        </p>
        ...
        {GridItems.gridItems.map((item, j) => {
          return (
            <Link href={"/" + item.link} key={"link-to-" + j + "-" + item.link}>
              <div className="grid-item" onMouseEnter={() => (!isSmall ? (elementsRef.current[j].current.scrollLeft = 0) : null)} onMouseMove={(event) => (!isSmall ? (elementsRef.current[j].current.scrollLeft += event.movementX * 5) : null)}>
                ...
                {item.media && !isSmall ? (
                  ...
                  <div className="mobile-poster">
                    <img key={item.poster} src={item.poster} />
                  </div>
                )}
