...
export default function Page() {
  ...
  return (
    <div className="page">
      ...
      <p>
        Prompting the ChatGPT API to draw an image in an 8x8 grid, outputting it on an LED matrix through Serial. Built with React and Arduino, in collaboration with{" "}
        <a href="https://lukasmoro.com" target="_blank">
          Lukas Moro
        </a>
        .
      </p>
      {/* </div> */}
      <video src="./media/gpt_smile.mp4" type="video/mp4" autoPlay={true} controls muted loop playsInline>
      ...
      <video src="./media/timer_swift.mp4" type="video/mp4" autoPlay={true} controls muted loop playsInline>
        Your browser does not support the video tag.
      </video>
      ...
      >
        <HeadComponent mouseX={mouseX} mouseY={mouseY} />
      </div>
      ...
      <video src="./media/lines.mp4" type="video/mp4" autoPlay={true} controls muted loop playsInline>
        Your browser does not support the video tag.
      </video>
      ...
      <video src="./media/colors.mp4" type="video/mp4" autoPlay={true} controls muted loop playsInline>
        Your browser does not support the video tag.
      </video>
      ...
      <div className="half">
        <div>
          <video src="./media/cupra_driving_bw.mp4" type="video/mp4" controls autoPlay={true} muted loop playsInline>
            Your browser does not support the video tag.
          </video>
          <div className="image-details">Autonomous -&#62; Driving -&#62; Speed</div>
        </div>
        <div>
          <video src="./media/cupra_autonomous_bw.mp4" type="video/mp4" controls autoPlay={true} muted loop playsInline>
            Your browser does not support the video tag.
          </video>
      ...
      <p>
        I created the ferro fluid animations using Blender, combined them with the interface elements in ProtoPie, and projection mapped that onto the physical model. The UI was done by{" "}
        <a href="https://mariespreitzer.com/" target="_blank">
          Marie Spreitzer
        </a>
        , the CAD by Nikita Zatonskiy.
        <br />
        <br />
      ...
      <video style={{ filter: "grayscale(1)" }} src="./media/cupra_ferro_1.mp4" type="video/mp4" controls autoPlay={true} muted loop playsInline>
        Your browser does not support the video tag.
      </video>
      ...
      <video src="./media/kinect.mp4" type="video/mp4" autoPlay={true} controls muted loop playsInline>
        Your browser does not support the video tag.
      </video>
