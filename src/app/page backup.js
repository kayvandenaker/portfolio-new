...
import Head from "./components/HeadComponent.js";
      ...
      <div className="container">
        <div className="intro">
          <div>
            ...
            <a href="https://www.hapticlabs.io" target="_blank">
              Hapticlabs
            </a>{" "}
            and{" "}
            ...
            while mastering IxD in{" "}
            <a href="https://www.umu.se/en/umea-institute-of-design/" target="_blank">
              Umeå
            </a>
            , formerly at{" "}
            <a href="https://www.above.se" target="_blank">
              Above
            </a>
            ,{" "}
            ...
            <br />
            <br />
            <a className="arrow-item" href="./files/Kay_van_den_Aker.pdf">
              Resume / Contact
            </a>
          </div>
        </div>
