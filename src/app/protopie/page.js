...
export default function Page() {
  return (
    <div className="page">
      ...
      <h3>Advanced Driver Assistance System</h3>
      ...
      <video src="./media/protopie_adas.mp4" type="video/mp4" controls muted loop playsInline>Your browser does not support the video tag.</video>
      <video src="./media/protopie_transparent_video.mp4" autoPlay={true} type="video/mp4" controls muted loop playsInline>Your browser does not support the video tag.</video>
      ...
      <video src="./media/protopie_dslr.mp4" type="video/mp4" controls muted loop playsInline>Your browser does not support the video tag.</video>

      <h3>APIs and Parsing JSON</h3>
      ...
      <video src="./media/protopie_json.mp4" type="video/mp4" controls muted loop playsInline>Your browser does not support the video tag.</video>

      <h3>Voice Interactions and Connect</h3>
      ...
      <video src="./media/protopie_laundry.mp4" type="video/mp4" controls muted loop playsInline>Your browser does not support the video tag.</video>
    </div>
  )
}